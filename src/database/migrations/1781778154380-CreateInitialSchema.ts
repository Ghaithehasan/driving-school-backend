...
export class CreateInitialSchema1781778154380 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."booking_booking_status_enum" AS ENUM('PENDING_PAYMENT', 'BOOKED', 'COMPLETED', 'NO_SHOW', 'CANCELLED')`);
        ...
        await queryRunner.query(`CREATE TABLE "booking" ("id" BIGSERIAL NOT NULL, "vehicle_source" "public"."booking_vehicle_source_enum" NOT NULL, "booking_status" "public"."booking_booking_status_enum" NOT NULL, "payment_status" "public"."booking_payment_status_enum" NOT NULL, "training_type" "public"."booking_training_type_enum" NOT NULL, "start_at" TIMESTAMP WITH TIME ZONE NOT NULL, "end_at" TIMESTAMP WITH TIME ZONE NOT NULL, "locked_until" TIMESTAMP WITH TIME ZONE, "student_id" bigint NOT NULL, "instructor_id" bigint NOT NULL, "vehicle_id" bigint, "replaced_booking_id" bigint, CONSTRAINT "REL_9689ded8014ca12a5e1ccbce7e" UNIQUE ("replaced_booking_id"), CONSTRAINT "PK_49171efc69702ed84c812f33540" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "booking_cancellations" ("id" BIGSERIAL NOT NULL, "cancellation_party" "public"."booking_cancellations_cancellation_party_enum" NOT NULL, "cancellation_reason" character varying(255), "cancelled_at" TIMESTAMP WITH TIME ZONE NOT NULL, "booking_id" bigint NOT NULL, CONSTRAINT "PK_8bb840ff63f3a96ed3a75c4bfef" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TYPE "public"."lesson_price_instructor_gender_enum" AS ENUM('MALE', 'FEMALE')`);
        await queryRunner.query(`CREATE TYPE "public"."lesson_price_training_type_enum" AS ENUM('MANUAL', 'AUTOMATIC', 'STUDENT_OWN_CAR')`);
        await queryRunner.query(`CREATE TABLE "lesson_price" ("id" BIGSERIAL NOT NULL, "instructor_gender" "public"."lesson_price_instructor_gender_enum" NOT NULL, "training_type" "public"."lesson_price_training_type_enum" NOT NULL, "price" numeric(10,2) NOT NULL, "effective_from" date NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "UQ_af3cd5a1a596d56102dc0557ffe" UNIQUE ("instructor_gender", "training_type", "effective_from"), CONSTRAINT "PK_37b360dbce374ede4bbc91ac0e4" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TYPE "public"."certificates_category_enum" AS ENUM('B', 'B1', 'C', 'D')`);
        await queryRunner.query(`CREATE TYPE "public"."certificates_request_status_enum" AS ENUM('PENDING_REVIEW', 'ACCEPTED', 'REJECTED', 'IN_PROGRESS', 'COMPLETED')`);
        await queryRunner.query(`CREATE TABLE "certificates" ("id" BIGSERIAL NOT NULL, "category" "public"."certificates_category_enum" NOT NULL, "request_status" "public"."certificates_request_status_enum" NOT NULL, "transport_requested" boolean NOT NULL, "requested_at" TIMESTAMP WITH TIME ZONE NOT NULL, "student_id" bigint NOT NULL, CONSTRAINT "PK_e4c7e31e2144300bea7d89eb165" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "vacations" ("id" BIGSERIAL NOT NULL, "day" date NOT NULL, "reason" character varying(255), "instructor_id" bigint NOT NULL, CONSTRAINT "PK_830973008a9b7e114e612442750" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "student_charges" ("id" BIGSERIAL NOT NULL, "charge_reason" "public"."student_charges_charge_reason_enum" NOT NULL, "amount_due" numeric(10,2) NOT NULL, "charge_status" "public"."student_charges_charge_status_enum" NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "due_at" date, "student_id" bigint NOT NULL, "booking_id" bigint, "certificate_id" bigint, CONSTRAINT "PK_b102cdbafeee6011d423e409b83" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "shamcash_transactions" ("id" BIGSERIAL NOT NULL, "transaction_id" character varying(100) NOT NULL, "sender_account" character varying(50), "verified_at" TIMESTAMP WITH TIME ZONE, "student_payment_id" bigint NOT NULL, CONSTRAINT "UQ_59e7d6973ecf50f90a7c6fec6b7" UNIQUE ("transaction_id"), CONSTRAINT "REL_34aa92bd6c20de5978564b3071" UNIQUE ("student_payment_id"), CONSTRAINT "PK_0a75e88b1cea222b6fa57e50689" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "user_role" ("id" BIGSERIAL NOT NULL, "user_id" bigint NOT NULL, "role_id" bigint NOT NULL, CONSTRAINT "UQ_f634684acb47c1a158b83af5150" UNIQUE ("user_id", "role_id"), CONSTRAINT "PK_fb2e442d14add3cefbdf33c4561" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "maintenance_vehicle" ("id" BIGSERIAL NOT NULL, "start_at" TIMESTAMP WITH TIME ZONE NOT NULL, "end_at" TIMESTAMP WITH TIME ZONE, "reason_note" character varying(255), "vehicle_id" bigint NOT NULL, CONSTRAINT "PK_695487b4a7876df7e70f2ae8564" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "vacations" ADD CONSTRAINT "FK_aa497e025febab8a60af99ee871" FOREIGN KEY ("instructor_id") REFERENCES "instructors"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "user_role" ADD CONSTRAINT "FK_32a6fc2fcb019d8e3a8ace0f55f" FOREIGN KEY ("role_id") REFERENCES "roles"("id") ON DELETE RESTRICT ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "maintenance_vehicle" ADD CONSTRAINT "FK_9bcf1032a45b5a668d45ce10724" FOREIGN KEY ("vehicle_id") REFERENCES "vehicles"("id") ON DELETE RESTRICT ON UPDATE NO ACTION`);
        await queryRunner.query(`CREATE UNIQUE INDEX "uq_booking_instructor_slot" ON "booking" ("instructor_id", "start_at") WHERE booking_status IN ('PENDING_PAYMENT','BOOKED')`);
        await queryRunner.query(`CREATE UNIQUE INDEX "uq_booking_vehicle_slot" ON "booking" ("vehicle_id", "start_at") WHERE vehicle_id IS NOT NULL AND booking_status IN ('PENDING_PAYMENT','BOOKED')`);
        await queryRunner.query(`CREATE INDEX "idx_booking_instructor_start" ON "booking" ("instructor_id", "start_at")`);
        await queryRunner.query(`CREATE INDEX "idx_booking_vehicle_start" ON "booking" ("vehicle_id", "start_at")`);
        await queryRunner.query(`CREATE INDEX "idx_booking_start_end" ON "booking" ("start_at", "end_at")`);
        await queryRunner.query(`CREATE INDEX "idx_booking_student" ON "booking" ("student_id")`);
        await queryRunner.query(`CREATE INDEX "idx_student_charges_student" ON "student_charges" ("student_id")`);
        await queryRunner.query(`CREATE INDEX "idx_student_charges_status" ON "student_charges" ("charge_status")`);
        await queryRunner.query(`CREATE INDEX "idx_student_payments_charge" ON "student_payments" ("student_charge_id")`);
        await queryRunner.query(`CREATE INDEX "idx_expenses_date" ON "expenses" ("expense_date")`);
        await queryRunner.query(`CREATE INDEX "idx_expenses_category" ON "expenses" ("category")`);
        await queryRunner.query(`CREATE INDEX "idx_vacations_instructor_day" ON "vacations" ("instructor_id", "day")`);
        await queryRunner.query(`CREATE INDEX "idx_availability_instructor_dow" ON "instructor_weekly_availabilities" ("instructor_id", "day_of_week")`);
        await queryRunner.query(`CREATE INDEX "idx_maintenance_vehicle_start" ON "maintenance_vehicle" ("vehicle_id", "start_at")`);
        await queryRunner.query(`CREATE INDEX "idx_certificates_student" ON "certificates" ("student_id")`);
        await queryRunner.query(`CREATE INDEX "idx_transport_attendance_trip" ON "transport_attendance" ("transport_trip_id")`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX "public"."idx_transport_attendance_trip"`);
        await queryRunner.query(`DROP INDEX "public"."idx_certificates_student"`);
        await queryRunner.query(`DROP INDEX "public"."idx_maintenance_vehicle_start"`);
        await queryRunner.query(`DROP INDEX "public"."idx_availability_instructor_dow"`);
        await queryRunner.query(`DROP INDEX "public"."idx_vacations_instructor_day"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."idx_student_payments_charge"`);
        await queryRunner.query(`DROP INDEX "public"."idx_student_charges_status"`);
        await queryRunner.query(`DROP INDEX "public"."idx_student_charges_student"`);
        await queryRunner.query(`DROP INDEX "public"."idx_booking_student"`);
        await queryRunner.query(`DROP INDEX "public"."idx_booking_start_end"`);
        await queryRunner.query(`DROP INDEX "public"."idx_booking_vehicle_start"`);
        await queryRunner.query(`DROP INDEX "public"."idx_booking_instructor_start"`);
        await queryRunner.query(`DROP INDEX "public"."uq_booking_vehicle_slot"`);
        await queryRunner.query(`DROP INDEX "public"."uq_booking_instructor_slot"`);
        await queryRunner.query(`ALTER TABLE "maintenance_vehicle" DROP CONSTRAINT "FK_9bcf1032a45b5a668d45ce10724"`);
        ...
        await queryRunner.query(`ALTER TABLE "vacations" DROP CONSTRAINT "FK_aa497e025febab8a60af99ee871"`);
        ...
        await queryRunner.query(`DROP TABLE "maintenance_vehicle"`);
